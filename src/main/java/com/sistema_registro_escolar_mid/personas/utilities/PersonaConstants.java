package com.sistema_registro_escolar_mid.personas.utilities;

public class PersonaConstants {
    public static final String PERSONA_NOT_FOUND = "Persona no encontrado";
    public static final String NOMBRE_REQUERIDO = "nombre es obligatorio";
